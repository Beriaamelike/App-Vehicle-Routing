...
class DepotEntryActivity : AppCompatActivity() {
    ...
    private lateinit var edtDepotX: EditText
    private lateinit var edtDepotY: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        edtDepotX = findViewById(R.id.edtDepotX)
        edtDepotY = findViewById(R.id.edtDepotY)
        ...
        btnSaveDepot.setOnClickListener {
            val x = edtDepotX.text.toString().toDoubleOrNull()
            val y = edtDepotY.text.toString().toDoubleOrNull()
            ...
            if (x == null || y == null || capacity == null || fleetSize == null || maxWorkingTime==null) {
    ...
    private fun updateLatLon(lat: Double, lon: Double) {
        edtDepotX.setText(lat.toString())
        edtDepotY.setText(lon.toString())
    }
